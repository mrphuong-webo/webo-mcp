...
function Test-AllowedFile {
    ...
    # Không đóng gói asset thư mục WordPress.org (.org upload qua SVN sau khi duyệt)
    if ($rel -match '(?i)^assets/(icon-128x128|icon-256x256|banner-772x250|banner-1544x500)\.(png|jpg|jpeg)$') {
        return $false
    }
